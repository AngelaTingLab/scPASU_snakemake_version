...
rule bw_track_after_filt:
    input: 
        ...
        minus="outputs/1d_merged_bam/dedup_uniq_genomicAfiltered_merged_minus.bam",
    output: 
        plus="outputs/qc_ucsc_tracks/after_genomicAfiltering_merged_plus.bw",
        minus="outputs/qc_ucsc_tracks/after_genomicAfiltering_merged_minus.bw",
    conda:
        "../envs/module_1.yaml"
    log:
...
rule bw_track_before_filt:
    input: 
        ...
        minus="outputs/1d_merged_bam/dedup_uniq_merged_minus.bam",
    output: 
        plus="outputs/qc_ucsc_tracks/before_genomicAfiltering_merged_plus.bw",
        minus="outputs/qc_ucsc_tracks/before_genomicAfiltering_merged_minus.bw",
    conda:
        "../envs/module_1.yaml"
    log:
